...
$json = $con->cUrl_Call(Get_Blocked_Solution_ByUser,$jsondata);
...
<li>
  ...
  <div class="box box-<?php echo $to; ?> collapsed-box box-solid ">
              <div class="box-header with-border">
                <h7 class="box-title"><?php echo $json["response"]["data"][$i]["getSolution_info"]["content"];?> </h7>
    ...
    <ul class='dropdown-menu' aria-labelledby='dLabel' style='color:black'>
      ...
      <li id='deleteanswer'><a href='#' onclick="undoans(<?php echo "'" .$json["response"]["data"][$i]["_id"]. "'"; ?>)"><i class="fa fa-undo"></i> <small>Undo</small></a></li>
