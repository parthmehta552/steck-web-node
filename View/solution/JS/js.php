...
function deleteans(str,str2,str3)
{
  var postdata = "&id="+str+"&id2="+str2+"&cont="+str3;
  $.ajax({
...
function undoans(str,str2,str3)
{
  var postdata = "&id="+str+"&id2="+str2+"&cont="+str3;
  $.ajax({
...
if(content.length <= 0)
{
$('#msg').html("<small class='label bg-green'>Please Enter Something</small><br>");
}else
{
...
function getqdataloading(str){
$('#data-'+str).html("<center><img src='View/gif/ring-alts.gif' height='40px' width='40px'> Please wait.. </center>");
                }
